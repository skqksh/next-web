    ...
    <Contens>
      <Box>
        <Text style={{ color: Colors.darkGrey }}>
          이 프로젝트는 <b>언택트 시대</b>를 맞이하여, 새롭게
          떠오르고있거나 수요가 증가하게 된 서비스를 조사하는 프로젝트
          입니다. <b>빅데이터 분석 전문가와 인공지능분야의 전문가</b>
          가 함께 프로젝트를 진행 중 입니다. 프로젝트를 수행하고자
          하는 열정과 본인이 할 업무를 책임감 있게 진행하실
          사수/부사수 분들을 모십니다. 바로
        </Text>
      </Box>
      <Box>
        ...
        <Box>
          <Text style={{ color: Colors.orangeRed }}>
            제이슨 스타뎀
          </Text>
        </Box>
      </Box>
